...
def config_agent(_flags):
    ...
    flags.DEFINE_integer("training_step", 750000, "Training time step")
    ...
    flags.DEFINE_integer("b_size", 200000, "Size of the replay memory")
    flags.DEFINE_integer("m_size", 512, "Minibatch size")
